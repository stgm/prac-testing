...
{-
  ...
  Updated by Tuba Kaya Chomette, Sander Leer, Martijn Stegeman
  6 October 2013
  
  Question 4 - time spent: 30 minutes
-}

module Week5Sol_Q4_RandomSudokuNRC where 

import Data.List
{-UPDATED: Use 'Week5Sol_Q3_NRC.hs' which contains the extra constraints for NRC sudokus
--         The random sudoku generator uses the function 'extendNode' (and thereby the
--         function 'prune' with the additional constraints).
-}
